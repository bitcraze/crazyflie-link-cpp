...
public:
    ...
    void run()
    {
        ...
        for (uint32_t i = 0; i < count; ++i)
        {
            ...
            // std::memcpy(p.payload(), temp, sizeof(temp));
...
int main()
{
    ...
    std::vector<std::string> uris({"radio://0/120/2M/E7E7E7E702"});
    ...
    for (auto& b: benchmarks) {
        std::cout << "Latency: Min: " << b.latency_min * 10.0f << " ms; Avg: " << b.latency_avg * 10.0f << " ms" << std::endl;
